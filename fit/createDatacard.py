...
def createDatacard(obsName, channel, nBins, obsBin, observableBins, physicalModel, year, nData, jes, lowerBound, upperBound, yearSetting):
    ...
    # 2023 values 
    ZX['2023preBPix_2e2mu'] = '0.735/1.256'
    ZX['2023preBPix_4e'] = '0.516/1.438'
    ZX['2023preBPix_4mu'] = '0.685/1.314'
    ZX['2023postBPix_2e2mu'] = '0.709/1.272'
    ZX['2023postBPix_4e'] = '0.530/1.533'
    ZX['2023postBPix_4mu'] = '0.671/1.332'
