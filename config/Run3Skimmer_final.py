## Examples for single file: python3 Run3Skimmer_final.py --input /eos/user/m/mmanoni/HZZ_prod_170625/Data/ --output /eos/user/m/mmanoni/HZZ_prod_170625/MC/PROD_samplesNano_2023preBPix_MC_0bbba422/ggH125/ZZ4lAnalysis_SKIMMED.root --mc
## Drop `--mc` option when running on Data
## Latest production: /eos/user/m/mmanoni/HZZ_prod_170625/
## /eos/user/m/mmanoni/HZZ_prod_170625/MC/PROD_samplesNano_2023preBPix_MC_0bbba422/ggH125/ZZ4lAnalysis.root
...
#Dataframe for FR CR ---- only DATA
if not MC:
    print("[Data]: FR CR dataframes")
...
if MC:
    ...
    print("QUI 6")
if not MC:
    print("[Data]: FR ZLL CR Snapshots")
...
if "H12" in inFileName:
    df_SR = (df_SR.Define('GENlep_pt', "getGENlep_vector(FidDressedLeps_pt)")
             ...
             # spencer
             .Define('GENpTj1', "FidZZ_GenJetLeadingIdx >= 0 ? GenJet_pt[FidZZ_GenJetLeadingIdx] : -99")
             .Define('GENpTj2', "FidZZ_GenJetSubleadingIdx >= 0 ? GenJet_pt[FidZZ_GenJetSubleadingIdx] : -99")
             .Define('GENNj', "FidZZ_nCleanedGenJetsPt30")
             .Define('GENmjj', "FidZZ_GenJetLeadingIdx >= 0 && FidZZ_GenJetSubleadingIdx >= 0 ? (ROOT::Math::PtEtaPhiMVector(GenJet_pt[FidZZ_GenJetLeadingIdx], GenJet_eta[FidZZ_GenJetLeadingIdx], GenJet_phi[FidZZ_GenJetLeadingIdx], GenJet_mass[FidZZ_GenJetLeadingIdx]) + ROOT::Math::PtEtaPhiMVector(GenJet_pt[FidZZ_GenJetSubleadingIdx], GenJet_eta[FidZZ_GenJetSubleadingIdx], GenJet_phi[FidZZ_GenJetSubleadingIdx], GenJet_mass[FidZZ_GenJetSubleadingIdx])).M() : -99")
             .Define('GENabsdetajj', "FidZZ_GenJetLeadingIdx >= 0 && FidZZ_GenJetSubleadingIdx >= 0  ? TMath::Abs(GenJet_eta[FidZZ_GenJetLeadingIdx] - GenJet_eta[FidZZ_GenJetSubleadingIdx]) : -99")
             .Define('GENdphijj', "FidZZ_GenJetLeadingIdx >= 0 && FidZZ_GenJetSubleadingIdx >= 0  ? deltaphi(ROOT::Math::PtEtaPhiMVector(GenJet_pt[FidZZ_GenJetLeadingIdx], GenJet_eta[FidZZ_GenJetLeadingIdx], GenJet_phi[FidZZ_GenJetLeadingIdx], GenJet_mass[FidZZ_GenJetLeadingIdx]), ROOT::Math::PtEtaPhiMVector(GenJet_pt[FidZZ_GenJetSubleadingIdx], GenJet_eta[FidZZ_GenJetSubleadingIdx], GenJet_phi[FidZZ_GenJetSubleadingIdx], GenJet_mass[FidZZ_GenJetSubleadingIdx])) : -99")
             .Define('GENpTHj', "FidZZ_GenJetLeadingIdx >= 0 ? (ROOT::Math::PtEtaPhiMVector(FidZZ_pt, FidZZ_eta, FidZZ_phi, FidZZ_mass) + ROOT::Math::PtEtaPhiMVector(GenJet_pt[FidZZ_GenJetLeadingIdx], GenJet_eta[FidZZ_GenJetLeadingIdx], GenJet_phi[FidZZ_GenJetLeadingIdx], GenJet_mass[FidZZ_GenJetLeadingIdx])).Pt() : -99")
             .Define('GENpTHjj', "FidZZ_GenJetLeadingIdx >= 0 && FidZZ_GenJetSubleadingIdx >= 0 ? (ROOT::Math::PtEtaPhiMVector(FidZZ_pt, FidZZ_eta, FidZZ_phi, FidZZ_mass) + ROOT::Math::PtEtaPhiMVector(GenJet_pt[FidZZ_GenJetLeadingIdx], GenJet_eta[FidZZ_GenJetLeadingIdx], GenJet_phi[FidZZ_GenJetLeadingIdx], GenJet_mass[FidZZ_GenJetLeadingIdx]) + ROOT::Math::PtEtaPhiMVector(GenJet_pt[FidZZ_GenJetSubleadingIdx], GenJet_eta[FidZZ_GenJetSubleadingIdx], GenJet_phi[FidZZ_GenJetSubleadingIdx], GenJet_mass[FidZZ_GenJetSubleadingIdx])).Pt() : -99")
             .Define('GENmHj', "FidZZ_GenJetLeadingIdx >= 0 ? (ROOT::Math::PtEtaPhiMVector(FidZZ_pt, FidZZ_eta, FidZZ_phi, FidZZ_mass) + ROOT::Math::PtEtaPhiMVector(GenJet_pt[FidZZ_GenJetLeadingIdx], GenJet_eta[FidZZ_GenJetLeadingIdx], GenJet_phi[FidZZ_GenJetLeadingIdx], GenJet_mass[FidZZ_GenJetLeadingIdx])).M() : -99")
...
df_SR.Snapshot('ZZTree/candTree', outFileName, sorted(vars), opts)
if "H12" in inFileName:
    opts.fMode = 'UPDATE'
    df_fail.Snapshot('ZZTree/candTree_failed', outFileName, sorted(vars_fail), opts)
