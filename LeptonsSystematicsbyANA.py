...
if (year=="2016"):
   ...
   muSF=TFile.Open("/afs/cern.ch/user/t/tjavaid/public/UL_SFrms/final_HZZ_SF_2017UL_mupogsysts_newLoose_abseta3_rmsSystLooseSIPIso.root") #latest muons with "RMS"
   ...
   muSF=TFile.Open("/afs/cern.ch/user/t/tjavaid/public/UL_SFrms/final_HZZ_SF_2018UL_mupogsysts_newLoose_abseta3_rmsSystLooseSIPIso.root") #latest muons with "RMS"
